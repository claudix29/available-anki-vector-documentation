# Vector CPU Replacement Guide (for unlocking)
...
Taken from here, all credit goes to wire
https://github.com/kercre123/unlocking-vector/blob/main/replacement_guide.md
