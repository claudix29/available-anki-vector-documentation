...
-   [Firmware Loading: \"Downgrade Not Allowed\"
    Error](/article/377-firmware-downgrade-not-allowed-error)
-   [Onboarding: \"No Devices Found\"
    Error](/article/376-onboarding-no-devices-found-error)
-   [Onboarding: \"Can\'t Add New Device\"
    Error](/article/378-onboarding-cant-add-new-device-error)
-   [Onboarding: \"Authorization Failed\"
    Error](/article/468-onboarding-authorization-failed-error)
:::
:::
