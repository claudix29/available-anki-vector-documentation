...
::: sections
[If you\'re not hearing any sounds from Vector,
please:]{style="font-weight: 400;"}

 

1.  [**Reboot
    Vector**](https://support.anki.com/hc/en-us/articles/360009804394-How-to-reset-erase-and-restore-Vector)
2.  Adjust the volume on Vector. To do this: open the Vector app \> tap
    Settings. If the volume is already on med or high, adjust it anyway
    to reset the volume
:::

 

[![Image_from_iOS\_\_1\_.png](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5e7d76ed2c7d3a7e9ae9e33f/img-3359-1585280564-523280372.png){width="517"
height="689"}]{style="font-weight: 400;"}

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/102-why-is-there-no-sound"}
