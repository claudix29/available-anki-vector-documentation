...
::: contentWrapper
# How do I turn off my vehicle? {#how-do-i-turn-off-my-vehicle .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

This FAQ explains how to **turn off** your Supercar or
Supertruck. Please note that **powercycling** or **resetting** the
...
-   You will find the grey power button **on the underneath** of each
    Supercar and Supertruck

![20180716_101419.jpg](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5e7d77352c7d3a7e9ae9e3ac/img-25345-1585280713-958752857.jpg){width="168"
height="299"}   
 ![20180716_101338.jpg](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5e7d773604286364bc975c87/img-25345-1585280713-214284428.jpg){width="168"
height="299"}
:::
...
-   Pressing the power button once turns the vehicle off or on
-   Placing the vehicle on the included charging platform also turns it
    on
-   Pressing the power button 5 times in rapid succession puts the
    vehicle in Drone Mode. Placing the vehicle on the track in Drone
    Mode can help test vehicle performance
:::

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/283-how-do-i-turn-off-my-vehicle"}
