...
::: contentWrapper
# Do I need the Starter Kit? {#do-i-need-the-starter-kit .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

Yes, the OVERDRIVE Starter Kit is required to play OVERDRIVE.  This
article explains why.

------------------------------------------------------------------------

::: sections
There are two reasons that the **OVERDRIVE Starter Kit** is required:

1.  ### Only the Starter Kit contains the Start piece

-   This segment is required to be part of every track you build.
-   Without it, well, there\'s no way to Start or Finish.
-   GroundShock and Skull are only available as part of the Starter Kit

```{=html}
<!-- -->
```
-   They cannot be purchased separately.
-   These two Supercars are required to complete the Tutorial portion of
    the OVERDRIVE app that teaches you how to play and use the cars.
:::

![Screenshot_2018-04-06-17-11-49.png](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5e7d77522c7d3a7e9ae9e3e4/img-3359-1585280673-2013209709.png){width="640"
height="360"}

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/252-do-i-need-the-starter-kit"}
