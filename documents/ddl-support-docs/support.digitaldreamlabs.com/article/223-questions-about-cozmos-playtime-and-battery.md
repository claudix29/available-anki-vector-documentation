...
::: contentWrapper
# Questions about Cozmo\'s Playtime and Battery {#questions-about-cozmos-playtime-and-battery .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

::: sections
Cozmo has an internal Lithium-ion battery that is charged using the
included charging dock connected to a powered USB outlet.
:::

------------------------------------------------------------------------

::: sections
Typical charging times for Cozmo are approximately 30 minutes, and
will vary based upon the USB power source that you use.
:::

------------------------------------------------------------------------

::: sections
When fully charged, that allows Cozmo to play for approximately 45
minutes. Actual playtime will vary based upon how you use Cozmo.
:::

------------------------------------------------------------------------

::: sections
Cozmo\'s internal battery is not user serviceable.
:::

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/223-questions-about-cozmos-playtime-and-battery"}
