...
::: contentWrapper
# Enabling Wi-Fi On Your Device {#enabling-wi-fi-on-your-device .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

The Vector Robot app uses Wi-Fi technology to communicate between Vector
and your mobile device. Wi-Fi is required to be enabled on your mobile
device or tablet to connect to Vector. Without Wi-Fi enabled, you won\'t
be able to set Vector up or connect with him using your device after
setup.

Please Note: You will not be able to see Vector in the Wi-Fi menu of
your device. You may see his Cubes, but they cannot be paired to. The
Vector Robot app handles all Wi-Fi communication and pairing with Vector
through the Wi-Fi Settings screen is not necessary.
...
2.  Find the \"Wi-Fi\" menu. This could be under its own dedicated
    section, or could be under the \"Networks\" menu.
3.  Drag the \"Wi-Fi\" slider to the \"On\" position.

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/476-enabling-wi-fi-on-your-device"}
