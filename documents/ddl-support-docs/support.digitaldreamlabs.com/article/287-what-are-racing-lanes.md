...
::: contentWrapper
# What are \"Racing Lanes\"? {#what-are-racing-lanes .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

OVERDRIVE and OVERDRIVE: Fast & Furious Edition include a \"Racing
Lanes\" option. Read more about this feature in this article.  

------------------------------------------------------------------------

::: sections
By default, you will have \"Racing Lanes\" activated. This means you
will have 4 lanes and will need to rotate your device to change lanes
(once per lane).

 

For a more dynamic driving experience, you can simply disable this
option by going to the Settings Menu and unticking \"Racing Lanes\". By
disabling this setting, you will need fewer device tilts to change
between 16 lanes. 
:::

------------------------------------------------------------------------

![Screenshot_20180410-134513.png](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5e7d77012c7d3a7e9ae9e367/img-25345-1585280718-1719363922.png){width="643"
height="482"}
...
::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/287-what-are-racing-lanes"}
