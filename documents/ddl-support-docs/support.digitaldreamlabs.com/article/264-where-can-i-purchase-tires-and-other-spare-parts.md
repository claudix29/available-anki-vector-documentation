...
::: contentWrapper
# Where can I purchase tires and other spare parts? {#where-can-i-purchase-tires-and-other-spare-parts .title}
...
::: sections
[Consumable]{style="font-weight: 400;"}** **parts, such as tires, are
available from the Digital Dream Labs site. Currently, DDL offers tires
only, which are available
[here](https://www.digitaldreamlabs.com/products/overdrive-tires){target="_blank"}.
:::
...
**Vehicle parts including batteries are not user serviceable and
therefore not available.**[ Please contact us via email
at ]{style="font-weight: 400;"}support@digitaldreamlabs.com for
troubleshooting cars or, if there is a known battery issue you may
purchase a [Car
Repair](https://www.digitaldreamlabs.com/products/repair-center){target="_blank"}.
:::

::: sections
:::

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/264-where-can-i-purchase-tires-and-other-spare-parts"}
