...
::: contentWrapper
# \"Vector Is Syncing\" Error Message {#vector-is-syncing-error-message .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

![](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/61d6021da0e8d7327cfa91dd/file-JK995hvgnq.jpg){style="width: 242px;"}

#### Causes:

When Vector first gets access to Wi-Fi, they need a moment to sync up
with the server! You may see this message if Vector still needs a few
more seconds to talk to the server after being connected to your
network. This may happen in the following cases:
...
The above steps will resolve this error in many cases. If the above does
not work:

1.  Reboot your router:\
    1.  Unplug the router from its power source. Leave it for at least
        30 seconds.
    2.  Plug the router back in, and give it 2 minutes to boot back up.
    3.  Press \"Try Again\" in the Vector app on your mobile device.
2.  Move Vector closer to the router. Wait another 10 seconds, then
    click Try Again.
3.  If the above steps do not fix the issue, please contact us via email
    at support@digitaldreamlabs.com.

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/479-vector-is-syncing"}
