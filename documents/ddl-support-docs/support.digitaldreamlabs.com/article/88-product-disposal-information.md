...
::: contentWrapper
# Product Disposal Information {#product-disposal-information .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

To properly dispose of an electronic product once it reaches its end of
life, check your local authority for recycling advice and facilities.

The separate collection and recycling of your product at the time of
disposal will help conserve natural resources and ensure that it is
recycled in a manner that protects human health and the environment.

::: sections
**[United
States](https://www.epa.gov/smm-electronics/regulations-initiatives-and-research-electronics-stewardship)**

\[US Environmental Protection Agency (EPA)
[www.epa.gov\]](http://www.epa.gov%5D)

**State Electronics Laws:**\
\"Twenty-five states currently have electronics recycling laws. The
National Center for Electronics Recycling (NCER) developed [an
interactive
map](http://www.ecycleclearinghouse.org/content.aspx?pageid=10)
\[www.ecycleclearinghouse.org - Requires Adobe Flash\] that helps to
find out detailed information on state regulations, including a brief
summary and link to the laws as well as key dates. Visit NCERs website
to find out more about [state electronics
laws](http://www.electronicsrecycling.org/?page_id=37)
\[www.ecycleclearinghouse.org\].\"
:::

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/88-product-disposal-information"}
