...
::: contentWrapper
# Curriculum and Other Resources {#curriculum-and-other-resources .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

This page provides multiple resources for parents, instructors, and
other model individuals.

# Curriculum

[Curriculum for Cork the
Volcano](https://cdn.shopify.com/s/files/1/0040/9806/4499/files/CtV-Curriculum_updated.pdf?v=1594149735)
(Programming)

[Curriculum for Swatch
Out!](https://cdn.shopify.com/s/files/1/0040/9806/4499/files/SwatchOut-K2-Art-Curriculum.pdf?v=1594149748)
(Art and Color Theory)

# Resources

[Case-Study of Puzzlets and
Findings](https://cdn.shopify.com/s/files/1/0040/9806/4499/files/Puzzlets_Evaluation_Findings_and_Design_Insights_1.pdf?v=1594149714)
from Avonworth School District

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/334-curriculum-and-other-resources"}
