...
::: contentWrapper
# Age Requirement Error Message {#age-requirement-error-message .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

Digital Dream Labs collects dates of birth for some accounts in
accordance with our [Privacy
Policy](https://www.digitaldreamlabs.com/policies/privacy-policy){target="_blank"}
and to enforce our [Terms of
Service](https://www.digitaldreamlabs.com/policies/terms-of-service){target="_blank"}.
In some cases, while setting up Vector, an error may appear that
states:\
\
**\"You do not meet the age requirement to register Vector. Ask your
parent or guardian to set up Vector.\"**

Two particular issues may cause this issue:

-   [Your Vector account has no date of birth set.\
    ]{style="background-color: initial;"}
-   The date of birth set in your Vector account does not meet the
    requirements of the [Terms of
    Service](https://www.digitaldreamlabs.com/policies/terms-of-service){target="_blank"}.

To resolve this issue, please Contact Us via email at
support@digitaldreamlabs.com and we will be glad to assist.

![](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/6165cb0fe5648623c88e3bd6/file-t1Zyz5Ne1l.jpg)

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/417-age-requirement-error-message"}
