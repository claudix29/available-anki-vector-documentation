...
::: contentWrapper
# Enabling Bluetooth On Your Device {#enabling-bluetooth-on-your-device .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

The Vector Robot app uses Bluetooth technology to communicate between
Vector and your mobile device. Bluetooth is required to be enabled on
your mobile device or tablet to connect to Vector. Without Bluetooth
enabled, you won\'t be able to set Vector up or connect with him using
your device after setup.

**Please Note: You will not be able to see Vector in the Bluetooth menu
of your device. You may see his Cubes, but they cannot be paired to. The
Vector Robot app handles all Bluetooth communication and pairing with
Vector through the Bluetooth Settings screen is not necessary.**
...
1.  Scroll through your Home screens to find the \"Settings\" app, then
    click on it to enter the Settings menu for your device.
...
3.  Drag the slider to the right so that the slider is green.
    ...
    15](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/61e5926b8200bc052eb7f6a8/file-UOCrEHNQ8g.jpg){style="width: 254px;"}
...
1.  Find the Settings app (this will vary by software setup and phone
    manufacturer):
    1.  If you have an App Drawer:
        1.  Locate the App Drawer button at the bottom of the screen.
        2.  Click the App Drawer icon.
        3.  Rotate through App Drawer screens until you find the
            Settings app.
...
2.  Find the \"Bluetooth\" menu. This could be under its own dedicated
    section, or could be under the \"Networks\" menu.
3.  Drag the \"Bluetooth\" slider to the \"On\" position.

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/475-enabling-bluetooth-on-your-device"}
