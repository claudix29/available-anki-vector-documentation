...
::: contentWrapper
# Why do I see a \"Tutorial Paused\" error? {#why-do-i-see-a-tutorial-paused-error .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

::: sections
If you have a new Cozmo and the message \"Put cozmo on a flat surface\",
keeps appearing during the setup tutorial, you may have missed removing
the clear plastic from beneath Cozmo\'s chin.  
...
::: sections
Here\'s a photo of the plastic packing material, look for the red arrows
and gently pull.
...
::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/216-why-do-i-see-a-tutorial-paused-error"}
