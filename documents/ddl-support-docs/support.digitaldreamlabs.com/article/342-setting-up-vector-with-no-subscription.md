...
::: contentWrapper
# Setting Up Vector with No Subscription {#setting-up-vector-with-no-subscription .title}

[](javascript:window.print() "Print this article"){.printArticle
aria-label="Print this Article"}

### I don\'t have a subscription, but I need to set up my Vector! {#i-dont-have-a-subscription-but-i-need-to-set-up-my-vector children-count="0"}

Digital Dream Labs is aware of an issue where, in the mobile app for
Vector, users may not be able to complete the setup steps outlined in
the app without a paid subscription. To work around this issue while
Digital Dream Labs works to address it, please use the following steps:\
\
1. Click \"Tips for Speaking\"\
2. Click \"Skip Section\"

**Note: These steps may need to be repeated through multiple sections in
setup.**

![](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5f7b8e9246e0fb0017989d31/file-4NjSJrZ0nM.png){style="width: 237px;"}

![](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5f7b8f6f46e0fb0017989d39/file-jrmwsJ7T7z.png){style="width: 234px;"}

::: {.articleRatings article-url="https://support.digitaldreamlabs.com/article/342-setting-up-vector-with-no-subscription"}
